...
perc_by_choices_by_victory <- perc_by_when_choices %>%
  group_by(victory) %>%
  mutate(mean_perc_hp_rest = mean(unlist(perc_hp_when_rest), na.rm=TRUE), mean_perc_hp_smith = mean(unlist(perc_hp_when_smith), na.rm=TRUE), mean_perc_hp_purge = mean(unlist(perc_hp_when_purge), na.rm=TRUE), mean_perc_hp_lift = mean(unlist(perc_hp_when_lift), na.rm=TRUE), mean_perc_hp_toke = mean(unlist(perc_hp_when_toke), na.rm=TRUE), mean_perc_hp_dig = mean(unlist(perc_hp_when_dig), na.rm=TRUE), mean_perc_hp_recall = mean(unlist(perc_hp_when_recall), na.rm=TRUE)) %>%
  summarize(rest = mean(mean_perc_hp_rest), smith = mean(mean_perc_hp_smith), purge = mean(mean_perc_hp_purge), lift = mean(mean_perc_hp_lift), dig = mean(mean_perc_hp_dig), recall = mean(mean_perc_hp_recall))
